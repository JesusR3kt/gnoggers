...
public class Matrix4f {
	...
	public Matrix4f scale(Vector3f vector) {
		return scale(vector, this, this);
	}
	
	public static Matrix4f scale(Vector3f vector, Matrix4f src, Matrix4f dest) {
	...
	public Matrix4f translate(Vector3f vector, Matrix4f dest) {
		return translate(vector, this, dest);
	}
